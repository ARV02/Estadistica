...
public class MedidasFragment extends Fragment {
    ...
    private MedidasViewModel mViewModel;

    public static MedidasFragment newInstance() {
        return new MedidasFragment();
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(MedidasViewModel.class);
